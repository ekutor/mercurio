 ...
 */
public class PagoOrden extends JDialog implements ActionListener, ObservadorEventos {

    private double paga;
    public CompraVista vista;
    public String cambio, pagaCon;
    private OrdenVista o;
    MenuVista menu;
    private boolean concatenar;
    private String cadena;

    public PagoOrden(MenuVista padre, CompraVista vista) {
        super(padre, true);
        menu = padre;
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAtras.setFont(new java.awt.Font("Verdana", 1, 14)); // NOI18N
        ...
        btnBorrar.setFont(new java.awt.Font("Verdana", 1, 14)); // NOI18N
        btnBorrar.setText("C");
        ...
        btn0.setFont(new java.awt.Font("Verdana", 1, 14)); // NOI18N
        btn0.setText("0");
        ...
        btnTerminarOrden.setMnemonic('T');
        ...
        pnlBotones.add(btnTerminarOrden);
        ...
        pnlCentroLayout.setHorizontalGroup(
            ...
            .addGroup(pnlCentroLayout.createSequentialGroup()
                ...
                .addGroup(pnlCentroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnlCambio, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)
                    .addComponent(pnlPagaCon, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)
                    .addComponent(pnlTotal, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)
                    .addGroup(pnlCentroLayout.createSequentialGroup()
                        .addComponent(pnlBotones, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addContainerGap())
                    .addComponent(pnlNumeros, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(pnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 54, Short.MAX_VALUE)
                        .addGap(347, 347, 347))))
        );
    ...
    public void modificarCompra() {
        if (!lblCambio.getText().equals("")) {
            FachadaInterfaz.getInstancia().modificarCompra("estado");
            dispose();
    ...
    public void escuchadorEvento(Object obj, String propiedad, Object valor) {
        if (propiedad.equals(PuntoDeVenta.CAMBIO_COMPRA)) {
            try {
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        try {
            ...
            vista.fachada.establecerImpuesto(Caja.COMPRA);
            o = new OrdenVista(vista.menu, true, this);
            o.setContenido(lst);
        } catch (Exception e) {
        }
